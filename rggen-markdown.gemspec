...
Gem::Specification.new do |spec|
  ...
  spec.files = `git ls-files lib LICENSE CODE_OF_CONDUCT.mkd README.md`.split($RS)
  spec.require_paths = ['lib']

  spec.required_ruby_version = '>= 2.3'

  spec.add_runtime_dependency 'ruport', '>= 1.7'
  spec.add_runtime_dependency 'ruport-wiki-table-formatter', '>= 0.2'
